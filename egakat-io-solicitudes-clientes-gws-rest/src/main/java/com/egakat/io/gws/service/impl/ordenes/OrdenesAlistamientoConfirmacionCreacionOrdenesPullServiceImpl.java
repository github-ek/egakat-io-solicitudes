...
@Service
@Slf4j
public class OrdenesAlistamientoConfirmacionCreacionOrdenesPullServiceImpl extends RestPullServiceImpl<String> {
	...
	protected ActualizacionDto asModel(String correlacion, String input) {
		...
		if (exists) {
			...
			case "ESPERANDO_CONFIRMACION_CREACION":
				result.setSubEstadoIntegracion("CREACION_CONFIRMADA");
				break;
			default:
				result = null;
				break;
