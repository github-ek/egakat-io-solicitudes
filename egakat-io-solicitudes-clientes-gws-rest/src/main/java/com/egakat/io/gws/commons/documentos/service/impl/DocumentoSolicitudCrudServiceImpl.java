package com.egakat.io.gws.commons.documentos.service.impl;
...
import com.egakat.io.gws.commons.documentos.repository.DocumentoSolicitudRepository;
...
public class DocumentoSolicitudCrudServiceImpl
		extends ExtendedIntegracionEntityCrudServiceImpl<DocumentoSolicitud, DocumentoSolicitudDto, String>
	...
	@Override
	public List<DocumentoSolicitudDto> findTopByEstado(String estado) {
		return null;
	}

	@Override
	public Slice<DocumentoSolicitudDto> findByEstado(String estado, Pageable pageable) {
		return null;
	}
}