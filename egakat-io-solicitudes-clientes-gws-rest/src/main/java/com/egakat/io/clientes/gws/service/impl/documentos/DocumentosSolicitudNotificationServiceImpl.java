...
@Service
@Slf4j
public class DocumentosSolicitudNotificationServiceImpl extends RestPushServiceImpl<ActualizacionDto, Object, Object>
		implements DocumentosSolicitudNotificacionReciboPushService {
	...
	protected Object push(Object output, ActualizacionDto input, ActualizacionDto actualizacion,
		...
		val status = SolicitudDespachoClienteEstadoConstants.DOC_RECIBIDO_OPL;
	...
	protected void onSuccess(Object result, Object output, ActualizacionDto input, ActualizacionDto actualizacion) {
		...
		val subestado = SolicitudDespachoClienteEstadoConstants.DOC_RECIBIDO_OPL;
