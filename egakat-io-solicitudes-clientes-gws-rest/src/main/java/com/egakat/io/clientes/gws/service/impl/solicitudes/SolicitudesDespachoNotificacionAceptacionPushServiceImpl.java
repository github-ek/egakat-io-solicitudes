...
public class SolicitudesDespachoNotificacionAceptacionPushServiceImpl
		...
		implements SolicitudesDespachoNotificacionAceptacionPushService {
	...
	protected String getOperacion() {
		val result = String.format("PUSH NOTIFICACION ACEPTACION %s", getIntegracion());
		return result;
	}
	...
	protected List<ActualizacionDto> getPendientes() {
		...
		val result = getActualizacionesService()
				.findAllNoNotificadasByIntegracionAndEstadoIntegracionIn(getIntegracion(), estado);
		return result;
	}
	...
	protected Object push(Object output, ActualizacionDto input, ActualizacionDto actualizacion,
		...
		val status = SolicitudDespachoClienteEstadoConstants.ACEPTADA_OPL;
	...
	protected void onSuccess(Object result, Object output, ActualizacionDto input, ActualizacionDto actualizacion) {
		...
		val subestado = SolicitudDespachoClienteEstadoConstants.ACEPTADA_OPL;
