...
@Entity
@Table(name = "entradas_integracion")
@DynamicUpdate
@Getter
@Setter
...
public class EntradaIntegracion extends BaseEntity<Long> {
	...
	@Column(name = "programar_notificacion", nullable = false)
	private boolean programarNotificacion;

	@Column(name = "notificacion_realizada", nullable = false)
	...
	@Column(name = "datos", length = -1, nullable = false)
	@NotNull
