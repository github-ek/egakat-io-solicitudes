...
public class MapEntidadDestruccionDecorator extends MapEntidadDecorator<Destruccion, Long> {

	public MapEntidadDestruccionDecorator(Decorator<Destruccion, Long> inner) {
		super(inner);
	}

	@Override
	protected Destruccion map(EtlRequestDto<Destruccion, Long> archivo, RegistroDto<Destruccion, Long> registro) {
