...
import static com.egakat.io.solicitudes.domain.salidas.Salida.AUTORIZADO_IDENTIFICACION;
import static com.egakat.io.solicitudes.domain.salidas.Salida.AUTORIZADO_NOMBRES;
import static com.egakat.io.solicitudes.domain.salidas.Salida.PREDISTRIBUCION_CROSSDOCK;
import static com.egakat.io.solicitudes.domain.salidas.Salida.REQUIERE_RECAUDO;
import static com.egakat.io.solicitudes.domain.salidas.Salida.VALOR_RECAUDAR;
...
public class MapEntidadSalidaDecorator extends MapEntidadDecorator<Salida, Long> {
	...
	protected Salida map(EtlRequestDto<Salida, Long> archivo, RegistroDto<Salida, Long> registro) {
		...
		val result = 
				...
				.predistribucionCrossdock(StringUtils.defaultString(getString(archivo, registro, PREDISTRIBUCION_CROSSDOCK)))

				.valorUnitarioDeclarado(valorUnitarioDeclarado)

				.autorizadoIdentificacion(StringUtils.defaultString(getString(archivo, registro, AUTORIZADO_IDENTIFICACION)))
				.autorizadoNombres(StringUtils.defaultString(getString(archivo, registro, AUTORIZADO_NOMBRES)))
				.requiereRecaudo(StringUtils.defaultString(getString(archivo, registro, REQUIERE_RECAUDO)))
