...
public abstract class SolicitudTercero extends Solicitud {
	...
	public SolicitudTercero(Long id, int version, LocalDateTime fechaCreacion, String creadoPor,
			...
			String idEstadoInventario, Long valorUnitarioDeclarado, @NotNull String requiereAgendamiento,
			LocalTime homi, LocalTime homa, @NotNull String terceroIdentificacion, @NotNull String terceroNombre,
			@NotNull String canalCodigoAlterno, @NotEmpty String requiereTransporte,
