package com.egakat.io.clientes.diageo.constants;

import java.time.LocalTime;

public class DiageoSolicitudesDespachoConstants {

	public static final String INTEGRACION_CODIGO = "DIAGEO_SOLICITUDES_DESPACHO";

	public static final String CLIENTE_CODIGO = "DIAGEO";
